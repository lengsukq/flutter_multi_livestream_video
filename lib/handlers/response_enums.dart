...
class Response {
  static const String audio_and_video_permission_denied =
      "ERROR audio and video permissions not authorized.";
  static const String audio_not_authorized =
      "ERROR audio permissions not authorized.";
  static const String video_not_authorized =
  ...
  // Observers
  static const String null_realtime_observers =
      "WARNING realtime observer is null";
  static const String null_audiovideo_observers =
      "WARNING audiovideo observer is null";
  static const String null_videotile_observers =
  ...
  // Video
  static const String video_start_response_null =
      "ERROR video start response is null";
  static const String video_stopped_response_null =
      "ERROR video stop response is null";

  // Audio Device
  static const String null_initial_audio_device =
      "ERROR failed to get initial audio device";
  static const String null_audio_device_list =
      "ERROR audio device list is null";
  static const String null_audio_device_update =
